...
public:
    ...
    inline int send(const OgreENetPacket& packet, enet_uint8 channelID=0) { return send(channelID, packet); }
    inline int send(enet_uint8 channelID, const OgreENetPacket& packet) { return enet_peer_send(_peer, channelID, packet._packet); }
